...
import {setGlobal} from "../api/global";
                    ...
                    <View style={{
                        ...
                        <View style={[styles.horizontal, {
                            ...
                            <TouchableOpacity activeOpacity={.9} onPress={() => {
                                ...
                                {
                                    this.state.showPwd ?
                                        <Image source={icon_PwdHide} style={{width: 20, height: 20}}/> :
                                        <Image source={icon_PwdShow} style={{width: 20, height: 20}}/>
                                }
                            </TouchableOpacity>
                        </View>
                        <TouchableOpacity onPress={() => {
                            ...
                            <Text style={[comStyles.commonBtn, {marginTop: 60}]}>登录</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{
                        flexDirection: 'row',
                        ...
                        <TouchableOpacity onPress={
                            ...
                            <Text style={{color: "#0071ff", fontSize: 14}}>账号注册 > </Text>
                        </TouchableOpacity>
                        <Text style={{color: "#0071ff", fontSize: 14}}> | </Text>
                        <TouchableOpacity style={{height: 14}} onPress={
                            () => {
                                navigate("ForgotPwd")
                            }
                        }>
                            <Text style={{color: "#0071ff", fontSize: 14}}>忘记密码 > </Text>
                        </TouchableOpacity>
                    </View>
                ...
                <View style={{justifyContent: 'flex-end', alignItems: 'center'}}>
                    ...
                    <View style={{flexDirection: "row", justifyContent: "center", width: "100%"}}>
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <Text style={[comStyles.commonBtn, {marginTop: 60}]}>修改密码</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
            ...
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        <Text style={[comStyles.commonBtn, {marginTop: 60}]}>注册</Text>
                    </TouchableOpacity>
                </View>
