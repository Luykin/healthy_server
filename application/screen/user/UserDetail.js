        ...
        return (
            <ScrollView style={[styles.container]} contentContainerStyle={{}}>
                ...
                <View style={{paddingHorizontal:ScreenUtil.scaleSize(30),marginTop:ScreenUtil.scaleSize(100)}}>
                    <Text style={{color:"#000",fontSize:ScreenUtil.scaleSize(36),fontWeight:"bold"}}>上传手持身份证正反照片</Text>
                    <View style={{flexDirection:"row",justifyContent:"space-between",marginTop:ScreenUtil.scaleSize(30)}}>
                        <TouchableOpacity onPress={()=>{
                            this.setState({
                                isVisible:true,
                                zheng:true,
                            ...
                            <ImageBackground
                                ...
                                style={{width:ScreenUtil.scaleSize(360),height:ScreenUtil.scaleSize(280),alignItems:"center",justifyContent:"center"}}>
                                <Image source={require("../../static/icons/30.png")} style={{width:ScreenUtil.scaleSize(120),height:ScreenUtil.scaleSize(120)}} />
                            </ImageBackground>
                        </TouchableOpacity>
