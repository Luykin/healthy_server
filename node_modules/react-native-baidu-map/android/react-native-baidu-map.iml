...
<module external.linked.project.id=":react-native-baidu-map" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-baidu-map" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_8">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/Users/mac/Documents/work/nurse/node_modules/react-native-baidu-map/android/libs/BaiduLBS_Android.jar:unspecified@jar" level="project" />
